...
>
> Current production state: **181 statewide measures/propositions /
> $5.75B reportable money** across 194 campaign records (v2 monetary
> $3.24B + v3 loans+in-kind+IE $2.51B; some measures collide via
> year-offset recoveries, hence the measure/campaign split). See
