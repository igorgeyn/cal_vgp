# Schedule C diagnostic v2 (resolver chain enabled)

Run 2026-05-13. Resolver chain: cover_sheet -> filer_name_explicit -> manual_override.

## Bucket totals — by attribution method
...
v1 baseline buckets (data/CalAccess/schedule_c_diagnostic.md):
- accepted: $242.6M
- no_cover_sheet: $434.7M
- bad_prop_or_year: $208.5M
- no_campaign_match: $8.2M
- unknown_stance: $0.6M

## Top filers per attribution method (top 25 each)
...
| Yes on 15 - Schools and Communities First sponsored by a Coalition of Labor Grou | $1,578,161.59 |

### `filer_name_explicit`

| Filer | Dollars |
|---|---|
| CALIFORNIANS AGAINST THE WRONG PRESCRIPTION - NO ON PROPOSITION 79 SPONSORED BY  | $39,954,375.65 |
...
| Californians United for Public Safety - No on Proposition 66 | $3,835,232.59 |
...
| TAXPAYERS FOR ACCOUNTABILITY & BETTER SCHOOLS(TABS), YES ON PROP. 39,A COALTN. O | $2,897,759.93 |
| Yes on Proposition 1, supported by health care organizations, Planned Parenthood | $2,710,625.68 |
...
| Yes on 71: Coalition for Stem Cell Research and Cures | $2,254,410.56 |
| Yes on 40. Protect California's Land, Air and Water.  Supported by Conservation  | $1,936,892.80 |
| California Voters First, Yes on 11 for CHANGE IN SACRAMENTO -- A Coaltion of Con | $1,932,245.00 |
| Yes on Prop. 57, Californians and Governor Brown for Public Safety and Rehabilit | $1,771,221.01 |
| NO ON 86 - STOP THE $2 BILLION TAX HIKE, A COALITION OF BUSINESS, LAW ENFORCEMEN | $1,661,844.25 |
| No on Prop 35-A Coalition of engineers, peace officers, firefighters, taxpayers, | $1,623,962.57 |
| No on 38 A Coalition of Parents Educators Business Labor and Public Safety | $1,569,517.42 |
| LETS FIX OUR SCHOOLS/YES ON 26, A COALITION OF PARENTS, TEACHERS, BUSINESS AND L | $1,565,508.68 |

## Top quarantined filers per reason (top 25 each)

### `failed/ambiguous_multi_prop`

| Filer | Dollars |
|---|---|
| Yes on Props 1 and 2, a bipartisan coalition of business, labor, Republicans, De | $5,382,222.64 |
...
| Million Voter Project Action Fund, No on 5 Yes on 10, Sponsored by Social Justic | $5,165.79 |
| Californians for Neighborhood Protection: Yes on Prop 99, No on Prop 98, A coali | $3,144.75 |
| Builders for Prop. 47 and Prop. 46 Sponsored by California Building Industry Ass | $3,101.50 |
| UNITE HERE, AFL-CIO, No On Propositions 68 and 70 Committee | $2,837.96 |
...
| Filer | Dollars |
|---|---|
| California Teachers Association/Issues PAC | $16,821,503.74 |
| Californians for Responsible Healthcare, Sponsored by Service Employees Internat | $13,973,828.04 |
| Save California Health Care and Public Education, Sponsored by Service Employees | $8,684,063.39 |
| Californians for Financial Education | $7,628,781.67 |
| HOLD POLITICIANS ACCOUNTABLE | $6,610,625.00 |
| Spirit of Democracy California | $6,154,234.57 |
| Democratic State Central Committee of CA | $4,731,303.23 |
| Alliance for a Better California, educators, firefighters, school employees, hea | $4,505,319.75 |
| Stop the Republican Recall of Governor Newsom | $4,010,038.67 |
| PROTECT VOTERS FIRST, SPONSORED BY HOLD POLITICIANS ACCOUNTABLE | $3,752,800.00 |
| Patel for Assembly 2024 | $3,552,854.63 |
...
| Ken Cooley for Assembly 2012 | $3,024,544.90 |
| Josh Newman for Senate 2024 | $2,943,341.24 |
| California Democratic Party | $2,889,559.25 |
| Anna Caballero for Senate 2018 | $2,701,979.02 |
| California Patriot Coalition - Recall Governor Gavin Newsom | $2,698,740.02 |
| The Governor Gray Davis Committee | $2,514,099.91 |
| Mueller for Senate 2024 | $2,342,355.02 |
| Democratic State Central Comm of Calif. | $2,281,625.26 |
| California Teachers Association/Association For Better Citizenship | $2,273,964.77 |
| Campaign for a Safe and Healthy California, sponsored by nonprofit environmental | $2,206,434.71 |
| Abigail Medina for Assembly 2016 | $2,087,694.19 |

### `failed/no_campaign_match`
...
### `failed/single_candidate_stale_out_of_window`

| Filer | Dollars |
|---|---|
| Yes on Proposition 68 - Californians for Clean Water and Safe Parks, Sponsored b | $45,753.79 |
| Protect Climate Funds and Stop Prop 70, CEJA Action Committee, a Project of Tide | $8,700.00 |
| Citizens for a Better California, a ballot measure committee sponsored by Senato | $5,100.38 |
| No on Proposition 18, the Water Bond - sponosored by a coalition of environmenta | $710.95 |

### `failed/unknown_stance`

| Filer | Dollars |
|---|---|
| PEOPLE AGAINST THE PROPOSITION 5 DECEPTION | $105,737.50 |
| California Charter Schools Association, An IRC 501(C)(3) Organization in Support | $100,264.60 |
| Stop Prop 17: Sponsored by Campaign for Consumer Rights-a coalition of consumer  | $82,156.04 |
| Family Farmers Against Prop 15 - Stop Higher Food Taxes | $77,139.44 |
| Californians United Against Prop 36, Sponsored by Ella Baker Center Action Fund | $74,224.59 |
| Stop Prop 63, a grassroots, common-sense effort for rational policy sponsored by | $44,435.49 |
